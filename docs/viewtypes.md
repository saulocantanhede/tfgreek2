...
If for some reason it is necessary to display all nodes, the command  A.displayReset() can be issued. This also resets all node labels to their definitions found in the [config.yaml](../app/config.yaml) file. 
