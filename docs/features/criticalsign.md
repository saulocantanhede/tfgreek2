...
This feature provides the text-critical marks present before or after a word. This feature is also populated for `phrase` or `subphrase` only in case these contain just one `word`.
