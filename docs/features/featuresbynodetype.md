...
* [137779 `word` nodes](#word-nodes): these nodes represents individual words in the text (and constitute the slots in the database; the smallest linguistic entity).
