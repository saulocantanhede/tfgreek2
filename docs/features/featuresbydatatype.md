...
[morph](morph.md#start) | [`Morphological`](featuresbygroup.md#morphological-features) | [`Node`](featuresbyfeaturetype.md#node-features) | [`word`](featuresbynodetype.md#word-nodes) [domain](domain.md#start) | [`Lexical`](featuresbygroup.md#lexical-features) | Morphological tag | `V-AAI-3S` `N-GSF`
