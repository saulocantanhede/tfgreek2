...
[bol_lemma](bol_lemma.md#start) |  [`Lexical`](featuresbygroup.md#lexical-features) | [`Node`](featuresbyfeaturetype.md#node-features) | lexical lemma provided by Bible Online Learner | `ὁ` `καί`
